...
import { FiguraRara } from './FiguraRara.js'
import { FiguraRaraDos } from './FiguraRaraDos.js'
...
class MyScene extends THREE.Scene {
  ...
  // la visualización de la escena
    ...
    createObjects(){
        ...
        this.taza.setRotationY(Math.PI/6)
        this.add(this.taza)
        ...
        this.cuadro2 = new Cuadro(18, 10, 'irithyll.jpg')
        this.cuadro2.setPosition(0, 18, -70)
        this.cuadro2.setRotationY(Math.PI/2)
        this.add(this.cuadro2)

        this.cuadro3 = new Cuadro(18, 10, 'valle.jpg')
        this.cuadro3.setPosition(0, 18, -25)
        this.cuadro3.setRotationY(Math.PI/2)
        this.add(this.cuadro3)

        this.cuadro4 = new Cuadro(12, 18, 'ciudad.jpg')
        this.cuadro4.setPosition(-60, 16, -99.7)
        this.add(this.cuadro4)

        this.cuadro5 = new Cuadro(18, 10, 'abeja.jpg')
        this.cuadro5.setPosition(-1, 18, -30)
        this.cuadro5.setRotationY(-Math.PI/2)
        this.add(this.cuadro5)

        this.figuraRara1 = new FiguraRara(0x904BF1)
        this.figuraRara1.setRotationY(Math.PI*1.3)
        this.figuraRara1.setPosition(-40,10,93)
        this.add(this.figuraRara1)

        this.figuraRara2 = new FiguraRara(0x4BF174)
        this.figuraRara2.setRotationY(Math.PI)
        this.figuraRara2.setPosition(-93,10,-40)
        this.add(this.figuraRara2)

        this.figuraRaraDos1 = new FiguraRaraDos(0x90f04c)
        this.figuraRaraDos1.setPosition(0,10,95)
        this.add(this.figuraRaraDos1)

        this.figuraRaraDos2 = new FiguraRaraDos(0x153175)
        this.figuraRaraDos2.setPosition(-95,10,-60)
        this.add(this.figuraRaraDos2)
    ...
    createDoors(){
        ...
        this.pomo = new THREE.Mesh (pomoGeom, materialamarillo)
        ...
        this.pomoViejo = new THREE.Mesh (pomoViejoGeom, materialamarillo)
    ...
    createRoom(){
        ...
        var marcoPuertaTresMesh = new THREE.Mesh(marcoPuertaTres, material)
    ...
    createBotonesPuzle(){
        var materialboton = new THREE.MeshPhongMaterial({color: 0xCF0000 })

        var boton1Geom = new THREE.CylinderGeometry (1,1,0.6,16)
        boton1Geom.translate(0,0.3,0)
        this.boton1 = new THREE.Mesh (boton1Geom, materialboton)
        ...
        this.boton2 = new THREE.Mesh (boton2Geom, materialboton)
        ...
        this.boton3 = new THREE.Mesh (boton3Geom, materialboton)
    ...
    onMouseDown(event){
        ...
        for(var i=0; i<this.panelNumeros.getPanelLength(); i++){
            ...
            if(panel.length > 0 && this.camaraActual == "personal"){
